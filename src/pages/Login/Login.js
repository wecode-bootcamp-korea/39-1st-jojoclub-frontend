          ...
          <div className="newCustomer">
            ...
            <div className="agreement">
              ...
              <div className="scrollBar">
                ...
                약관, 개인정보처리방침 및 고객 서비스와 특정 기능, 게시물 또는
                홍보와 관련하여 본 사이트 전체에서 제시하는 여타 조건과 정책 (본
                약관(통칭하여, '본 약관'이라 합니다)의 일부이며 그에 포함되는
                것으로 간주됩니다)에 따라, 이용자에게 본 사이트상 컨텐츠와
                서비스를 제공합니다. 이용자는 본 사이트에 접속하거나
                이용함으로써 본 약관을 읽고, 이해하였으며, 일체의 제한요건이나
                자격을 불문하고 본 약관에 따르기로 합의하였음을 인정하는
                것입니다 .
              </div>
              <div className="agree">
                <label>
              ...
              <div className="scrollBar">
                ...
                데이터 관리, 회원제 서비스 이용에 따른 본인확인, 불량회원의 부정
              ...
              <div className="scrollBar">
                ...
                서비스(제품)개발 및 특화, 접속 빈도 파악 또는 회원의 서비스
                이용에 대한 통계
              </div>
              <div className="agree">
                <label>
